	...
	return (
		<main className="bg-light-blue">
			<div className="container mx-auto py-20">
				{/* Title */}
				<h1 className="text-title-color font-bold text-[48px] leading-[64px] mb-9">Latest Post</h1>
							...
							<div className="bg-white p-5 flex flex-row gap-x-9 rounded-lg hover:shadow-sm hover:shadow-primary-60 transition-colors duration-500">
								...
								<div className="basis-2/3 flex flex-col justify-between items-start gap-y-4 py-1">
									...
									<p className="text-body-color leading-[26px] my-2">
										...
										sapiente corrupti ab officia unde accusantium pariatur quia doloribus excepturi
										in inventore consequuntur minus? Ut officia exercitationem modi hic.Lorem ipsum
										dolor sit amet consectetur adipisicing elit. Ipsa ex, mag excepturi in inventore
										consequuntur minus? Ut officia exercitationem modi hic.
									</p>
									<a
										href={`/post/1`}
					...
					<aside className="w-3/12 flex flex-col gap-y-6">
						...
						<div className="bg-primary-60 rounded-lg p-6">
							...
							<div className="flex flex-col items-center p-4 gap-y-3 my-2">
								<h4 className="text-white font-heading font-semibold text-[24px]">Bhomit Kapoor</h4>
								<p className="text-white my-3 text-center leading-[26px]">
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro officiis illo unde
									eligendi nihil, consectetur magni minus dignissimos eaque facere.
								</p>
							</div>
